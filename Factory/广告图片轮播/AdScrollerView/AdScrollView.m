...
- (void)setAdTitleArray:(NSArray *)adTitleArray withShowStyle:(AdTitleShowStyle)adTitleStyle
{
    ...
    _leftAdLabel.frame = CGRectMake(10, UISCREENHEIGHT - 20, UISCREENWIDTH, 20);
    [_leftImageView addSubview:_leftAdLabel];
    _centerAdLabel.frame = CGRectMake(10, UISCREENHEIGHT - 20, UISCREENWIDTH, 20);
    [_centerImageView addSubview:_centerAdLabel];
    _rightAdLabel.frame = CGRectMake(10, UISCREENHEIGHT - 20, UISCREENWIDTH, 20);
    ...
    _leftAdLabel.font = [UIFont boldSystemFontOfSize:16];
    _centerAdLabel.font = [UIFont boldSystemFontOfSize:16];
    _rightAdLabel.font = [UIFont boldSystemFontOfSize:16];
